    ...
    try:
        ...
        get_ordenes_venta_query = f"""
			...
			select 
				...
				ov.fecha_entrega_solicitada::date,
            ...
            inner join {ENV}.direccion d on d.id = ov.id_direccion_entrega
			WHERE ov.estado = 'lista' and ov.con_envio = true
			ORDER BY ov.fecha_pedido DESC
		"""
        ordenes_venta = run_query(cur, get_ordenes_venta_query)
        ...
        return {
            ...
            "body": json.dumps({"pedidos": ordenes_venta}, default=str),
        }
