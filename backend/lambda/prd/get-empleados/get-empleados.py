...
def lambda_handler(event, context):
    ...
    try:
        ...
        get_empleados_query = f'select e.id, e.dni, e.email, r.nombre as rol, e.nombre, e.apellido, e.telefono from {ENV}.empleado e inner join {ENV}.rol r on r.id = e.id_rol where e.activo = true;'
        empleados = run_query(cur, get_empleados_query)
        ...
        return {
            ...
            "body": json.dumps({"Empleados": empleados}, default=str),
        }
