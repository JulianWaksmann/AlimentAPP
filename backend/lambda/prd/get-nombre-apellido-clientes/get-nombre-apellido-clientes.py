...
def lambda_handler(event, context):
    ...
    try:
        ...
        get_clientes_query = f'SELECT id, nombre_contacto, apellido_contacto FROM {ENV}.cliente'
        clientes = run_query(cur,get_clientes_query)
        print(clientes)
        ...
        return {
            ...
            "body": json.dumps({"clientes": clientes}),
        }
