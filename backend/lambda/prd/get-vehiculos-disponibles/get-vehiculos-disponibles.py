...
def lambda_handler(event, context):
    ...
    try:
        ...
        get_vehiculos_query = f'select * from {ENV}.vehiculo where disponible = true;'
        vehiculos = run_query(cur, get_vehiculos_query)
        ...
        return {
            ...
            "body": json.dumps({"vehiculos": vehiculos}, default=str),
        }
