...
def lambda_handler(event, context):
    ...
    try:
        ...
        stock_materia_prima_query = f"""
        select 
            id_materia_prima, 
            nombre as nombre_materia_prima, 
            unidad_medida, 
            cantidad_disponible 
        from {ENV}.cantidad_disponible_materia_prima
        """
        stock_materia_prima_result = run_query(cur,stock_materia_prima_query)
        ...
        return {
            ...
            "body": json.dumps({"stock_materia_prima": stock_materia_prima_result}, default = str),
        }
