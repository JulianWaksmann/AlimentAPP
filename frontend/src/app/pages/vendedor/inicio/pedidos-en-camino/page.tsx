...
import { entregarPedido } from '@/app/api/pedidosVenta';
...
const PedidosenCaminoPage = () => {
    ...
    useEffect(() => {
        ...
        async function handleEntrega(idEnvio: number){
            try {
                await entregarPedido(idEnvio, "entregado");
    ...
    return (
        <div>
            <div className="p-4 sm:p-6 lg:p-8">
                <h1 className="text-2xl font-bold mb-6 text-center">Pedidos en Camino</h1>
...
export default PedidosenCaminoPage;