...
//   const [lineasProduccion, setLineasProduccion] = useState<LineaDeProduccion[]>([]);

//   useEffect(() => {
//     async function getLineasDeProduccion(){
//       const res = await GetLineasProduccion();
//       setLineasProduccion(res);
//     }
//     getLineasDeProduccion();
//   }, []);
//     useEffect(() => {
//     fetchLineas();
//   }, []);
...
//       <h1 className="text-2xl font-bold text-primary">Lineas de Produccion</h1>
//       <p className="mt-1 text-sm text-neutral-dark">
//         Lista de las lineas de produccion.
//       </p>

//     <TablaLineasProduccion lineas={lineasProduccion} onUpdated={fetchLineas}/>
//     </div>
