...
const menuItems = [
  { name: "FINANZAS", href: "/pages/gerente/inicio/finanzas" },
  { name: "PRODUCCION", href: "/pages/gerente/inicio/produccion" },
  { name: "PEDIDOS", href: "/pages/gerente/inicio/pedidos" },
];

const GerenteLayout = ({ children }: { children: React.ReactNode }) => {
  ...
  return (
    <div className="flex h-screen bg-neutral-light">
      ...
      >
        <h2 className="mb-6 text-center text-xl font-bold">GERENTE</h2>
