    ...
    <div className="mx-auto max-w-4xl rounded-lg bg-white p-4 shadow-lg md:p-6 relative">
      ...
      <div className="grid grid-cols-1 gap-4 ">
        <div>
          ...
          <select id="cliente" value={Number(idClienteSeleccionado)} onChange={(e) => {setIdClienteSeleccionado(Number(e.target.value)); console.log(idClienteSeleccionado)}} className="w-full rounded border px-3 py-2">
            <option value={0} key={""} disabled>Selecciona un cliente</option>
            {ClientesLista.map((c) => (
